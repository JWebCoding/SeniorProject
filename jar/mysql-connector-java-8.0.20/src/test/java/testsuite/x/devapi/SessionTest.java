...
public class SessionTest extends DevApiBaseTestCase {
    ...
    public void testBug28616573() throws Exception {
        ...
        try {
            ...
            assertThrows(CJCommunicationsException.class, "Unable to library.test.connect to any of the target hosts\\.", cli2::getSession);
    ...
    public void basicSessionFailoverRandomSort() {
        ...
        assertThrows(CJCommunicationsException.class, "Unable to library.test.connect to any of the target hosts\\.", () -> {
