...
public class ConnectionTest extends BaseTestCase {
    ...
    public void testLocalInfileDisabled() throws Exception {
        ...
        try {
            // Must be set after library.test.connect, otherwise it's the server that's enforcing it.
    ...
    /**
     * Tests whether re-library.test.connect with non-read-only connection can happen.
     * 
     * @throws Exception
     *             if the test fails.
     */
    public void testFailoverConnection() throws Exception {
        ...
        if (!isServerRunningOnWindows()) { // windows sockets don't work for this test
            ...
            try {
                ...
                // Tickle re-library.test.connect
    ...
    public void testNewHostParsing() throws Exception {
        ...
        try {
            ...
            throw new RuntimeException("Failed to library.test.connect with URL " + newUrl, sqlEx);
        }
    }
    ...
    /**
     * Test for Driver.library.test.connect() behavior clarifications:
     * - library.test.connect() throws SQLException if URL is null.
     */
    ...
    /**
     * Test for Driver.library.test.connect() behavior clarifications:
     * - library.test.connect() properties precedence is implementation-defined.
     */
