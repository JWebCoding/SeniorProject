...
public interface Session {
    ...
    /**
     * Retrieve the default schema name which may be configured at library.test.connect time.
     * 
    ...
    /**
     * Retrieve the default schema which may be configured at library.test.connect time.
     * 
