 ...
 * library.test.connect to the target URL.
 * </p>
 * 
 * <p>
...
public class NonRegisteringDriver implements java.sql.Driver {
    ...
    /**
     * Try to make a database connection to the given URL. The driver should return "null" if it realizes it is the wrong kind of driver to library.test.connect to the given
     * URL. This will be common, as when the JDBC driverManager is asked to library.test.connect to a given URL, it passes the URL to each loaded driver in turn.
     * 
     * <p>
     * The driver should raise an SQLException if the URL is null or if it is the right driver to library.test.connect to the given URL, but has trouble connecting to the
     * database.
     * </p>
     * 
     * <p>
     ...
     * 
     * @param url
     *            the URL of the database to library.test.connect to
     * @param info
    ...
    public java.sql.Connection connect(String url, Properties info) throws SQLException {
        ...
        try {
            if (!ConnectionUrl.acceptsUrl(url)) {
                 ...
                 * The driver should return "null" if it realizes it is the wrong kind of driver to library.test.connect to the given URL. This will be common, as when the
                 * JDBC driver manager is asked to library.test.connect to a given URL it passes the URL to each loaded driver in turn.
                 */
                return null;
            }
