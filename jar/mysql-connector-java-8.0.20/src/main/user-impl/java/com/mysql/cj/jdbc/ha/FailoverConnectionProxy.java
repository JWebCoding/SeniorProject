...
public class FailoverConnectionProxy extends MultiHostConnectionProxy {
     ...
     * This process tries to library.test.connect, sequentially, to the next host in the list. The primary host may or may not be excluded from the connection attempts.
     * 
     * @param failedHostIdx
