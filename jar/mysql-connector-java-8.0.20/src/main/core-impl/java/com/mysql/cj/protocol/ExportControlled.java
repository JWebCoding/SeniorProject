...
public class ExportControlled {
    ...
    private static String[] getAllowedProtocols(PropertySet pset, ServerVersion serverVersion, String[] socketProtocols) {
        ...
        // It is problematic to enable TLSv1.2 on the client side when the server is compiled with yaSSL. When client attempts to library.test.connect with
        ...
        // for server versions which are known to be compiled with OpenSSL.
            ...
            // connection to old MySQL 5.7 GPL releases will fail by default, user must use enabledTLSProtocols=TLSv1.1 to library.test.connect them.
